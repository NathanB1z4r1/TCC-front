<template>
    <div>
      ...
      <div class="center">
        <div class="login">
          <div class="field">
            <label class="label-field mr-4" for="">Colaborador:</label>
            <input class="colaborador" type="text" placeholder=""></input>
            <label class="label-field mr-4" for="">EDV:</label>
            <input class="EDV" type="text" placeholder=""></input>
          </div>
          <div class="field">
        ...
        <div class="additional-buttons">
          <button class="label-field2">Validar</button>
        </div>
      </div>
    </div>
  </template>
